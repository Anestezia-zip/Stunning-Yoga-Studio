export const features = [
  {
    ...
    title: "Yoga for every step of Your journey",
    text: "Begin your transformation with programs that gently guide you through the fundamentals of yoga. Build flexibility, reduce stress, and experience the joy of connecting with your body and mind.",
    button: {
      icon: "/images/lotus-icon.png",
      label: "Start first class free",
      link: "/get-started",
    },
  },
  {
    ...
    caption: "Unlock New Potential",
    title: "Tailored classes with top instructors",
    text: "Explore advanced poses, refine your practice, and receive one-on-one guidance from world-class instructors. Whether you want to deepen your mindfulness or master challenging asanas, we've got you covered.",
    button: {
      icon: "/images/lotus-icon.png",
      label: "Browse Advanced Programs",
...
export const advancedPrograms = [
  {
    ...
    description: "An intensive practice designed to build strength and endurance through challenging poses.",
    videoUrl: "https://www.youtube.com/embed/6LeKFE_aB4I",
    guaranteedResults: "Improved muscle strength, enhanced physical fitness, and increased stamina."
  },
  {
    id: 2,
    title: "Power yoga for strength",
    description: "A practice focusing on deep stretches and balancing poses to improve flexibility and coordination.",
    videoUrl: "https://www.youtube.com/embed/X5fP_YS6olU",
    guaranteedResults: "Improved flexibility, enhanced balance, and greater body awareness."
  },
  {
    id: 3,
    title: "Vinyasa flow for intermediate and advanced levels",
    description: "A dynamic sequence of poses designed to synchronize breath and movement.",
    videoUrl: "https://www.youtube.com/embed/Fbie_YadIEM",
    guaranteedResults: "Breath-movement harmony, improved cardiovascular endurance, and stress relief."
  },
  {
    id: 4,
    title: "Advanced hatha yoga intensive",
    description: "A deeper dive into hatha yoga to challenge your practice and explore advanced techniques.",
    videoUrl: "https://www.youtube.com/embed/HhHeKqdcAcY",
    guaranteedResults: "Mastery of advanced asanas, enhanced focus, and increased energy levels."
  }
];

export const advancedYogaPoses = [
  {
    id: 1,
    imgSrc: "/images/advanced-pose-1.png", 
    alt: "Scorpion Pose (Vrschikasana)",
    title: "Scorpion Pose (Vrschikasana)",
    description:
      "A challenging inversion that requires balance, strength, and flexibility. This pose improves spinal mobility and strengthens the shoulders and core."
  },
  {
    id: 2,
    imgSrc: "/images/advanced-pose-2.png",
    alt: "Firefly Pose (Tittibhasana)",
    title: "Firefly Pose (Tittibhasana)",
    description:
      "This arm balance challenges your core and shoulder strength while improving hip flexibility and focus. It's a rewarding test of balance and control."
  },
  {
    id: 3,
    imgSrc: "/images/advanced-pose-3.png",
    alt: "King Pigeon Pose (Eka Pada Rajakapotasana)",
    title: "King Pigeon Pose (Eka Pada Rajakapotasana)",
    description:
      "A deep backbend and hip opener, King Pigeon Pose stretches the thighs, groin, and abdomen while improving posture and emotional release."
  },
  {
    id: 4,
    imgSrc: "/images/advanced-pose-4.png",
    alt: "Eight Angle Pose (Astavakrasana)",
    title: "Eight Angle Pose (Astavakrasana)",
    description:
      "A dynamic arm balance that builds core strength, arm power, and mental focus. Mastery of this pose symbolizes agility and control."
  }
];
...
export const plans = [
  {
    ...
    priceMonthly: 15,
    priceYearly: 10,
    caption: "Perfect for yoga newcomers",
    features: [
      "Access to 50+ beginner classes",
      "Weekly guided meditations for relaxation and focus",
      "Learn breathing techniques to reduce stress",
      "Community support",
    ],
    icon: "/images/lotus-1.png",
    logo: "/images/lotus-1.png",
  },
  {
    id: "1",
    title: "Pro",
    priceMonthly: 49,
    priceYearly: 39,
    caption: "Ideal for experienced yogis",
    features: [
      "Includes all Beginner plan features and benefits",
      "Unlimited access to all yoga levels and styles",
      "Exclusive live-streamed classes with top yoga experts",
      "Personalized and detailed yoga plans tailored to you",
    ],
    icon: "/images/lotus-2.png",
    logo: "/images/lotus-2.png",
  },
  {
    id: "2",
    title: "Instructor",
    priceMonthly: 89,
    priceYearly: 69,
    caption: "Designed for yoga teachers",
    features: [
      "All Pro features",
      "Workshops on teaching methods",
      "Certifications & training programs",
      "Management tools for yoga classes",
    ],
    icon: "/images/lotus-3.png",
    logo: "/images/lotus-3.png",
  },
];
...
export const faq = [
  {
    id: "0",
    question: "How do I start my yoga journey with your platform?",
    answer:
      "Getting started is simple! Just sign up, choose your preferred plan, and explore a variety of classes designed for all levels.",
  },
  {
    id: "1",
    question: "How do I customize my yoga practice to fit my goals?",
    answer:
      "Our platform allows you to choose classes based on your goals, such as flexibility, relaxation, or strength building. You can even save your favorites!",
  },
  {
    id: "2",
    question: "How do I track my progress in yoga?",
    answer:
      "Our platform includes tools to log your completed sessions, monitor improvements, and celebrate milestones on your yoga journey.",
  },
  {
    id: "3",
  ...
  {
    id: "6",
    question: "Can beginners practice yoga on your platform?",
    answer:
      "Absolutely! We offer a wide range of beginner-friendly classes, detailed guidance, and step-by-step tutorials to help you get started.",
  },
  {
    id: "7",
...
export const testimonials = [
  {
    ...
    role: "Beginner Yogi",
    avatarUrl: "/images/person-3.png",
    comment:
      "Joining this yoga program has been life-changing! The instructors are so supportive, and I feel more connected to myself every day.",
  },
  {
    id: "1",
    name: "Ethan Harper",
    role: "Intermediate Practitioner",
    avatarUrl: "/images/person-2.png",
    comment:
      "The personalized yoga plans helped me improve my poses and flexibility. I can’t recommend this enough!",
  },
  {
    id: "2",
    name: "John Torres",
    role: "Studio Owner",
    avatarUrl: "/images/person-1.png",
    comment:
      "This platform made managing my yoga studio so much easier. The tools are intuitive, and my clients love the classes.",
  },
  {
    id: "3",
    name: "James Robinson",
    role: "Advanced Practitioner",
    avatarUrl: "/images/person-4.png",
    comment:
      "The live classes with expert yogis are incredible. I’ve learned advanced techniques that I never thought I could master.",
  },
  {
    id: "4",
    name: "Emily Carter",
    role: "Yoga Enthusiast",
    avatarUrl: "/images/person-5.png",
    comment:
      "The meditation sessions have brought so much peace into my life. It's become a daily ritual I can’t live without.",
  },
  {
    id: "5",
    name: "Oliver Brooks",
    role: "Yoga Instructor",
    avatarUrl: "/images/person-6.png",
    comment:
      "This program has everything an instructor could need. From guided resources to community support, it’s simply the best.",
  },
];
...
export const beginner_poses = [
  {
    id: 2,
    imgSrc: "/images/pose-1.png",
    alt: "Balasana (Child's Pose)",
    title: "Balasana (Child's Pose)",
    description: "A restful pose that stretches the hips, thighs, and back while calming the mind and relieving tension."
  },
  {
    id: 4,
    imgSrc: "/images/pose-2.png",
    alt: "Bhujangasana (Cobra Pose)",
    title: "Bhujangasana (Cobra Pose)",
    description: "A heart-opening pose that strengthens the spine, opens the chest, and stretches the arms and shoulders."
  },
  {
    id: 3,
    imgSrc: "/images/pose-3.png",
    alt: "Virabhadrasana 3",
    title: "Virabhadrasana 3",
    description: "A balancing pose that builds strength in the legs, core, and back while improving focus and stability."
  },
  {
    id: 1,
    imgSrc: "/images/pose-4.png",
    alt: "Virabhadrasana 1",
    title: "Virabhadrasana 1",
    description: "A strong standing pose that improves balance, strengthens the legs, and opens the hips and chest."
  }
];
